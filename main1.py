...
import random
import string
OWNERS = [1601699921, 1601699921]  # replace with admin's ids
USERS_FILE = "users.txt"  # dont change
bot_token = '7408774544:AAHdU6J-rSbp8U-XpeAt-OJ6m0RkgCKo-kI'  # edit to your bot token
...
def helpcmd(message):
    ...
    f"\n\nTo buy bot access - message @smsbinhvn"
